    ...
    <div class="col-lg-12 mb-5">
      <form action="<?php echo site_url('EditProfilMember/save');?>" method="post" enctype="multipart/form-data">
        ...
        <div class="control-group">
          ...
          <input type="text" class="form-control" name="tlpn" id="telepon" placeholder="Telepon"
             data-validation-required-message="Please enter your Telepon" value="<?php echo $member->tlpn; ?>" />
          <p class="help-block text-danger"></p>
        </div>
        <div class="control-group">
          <label></label>
