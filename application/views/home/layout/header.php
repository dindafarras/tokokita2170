        ...
        <div class="row border-top px-xl-5">
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="<?php echo site_url('main/index'); ?>" class="nav-item nav-link active">Home</a>
                ...
                <?php } else { ?>
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="<?php echo site_url('main/index'); ?>" class="nav-item nav-link active">Beranda</a>
                            ...
                            <div class="navbar-nav ml-auto py-0">
                                ...
                                <a href="<?php echo site_url('EditProfilMember')?>" class="nav-item nav-link">Profil</a>
                            </div>
                        </div>
                        <?php } ?>
                </nav>
                <?php 
            $loc=$this->uri->segment('1||main');
            if($loc==""){
