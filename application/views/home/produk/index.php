                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" arial-label="Basic Example">
                                    ...
                                    <a href="<?php echo site_url('produk/delete/'.$val->idProduk.'/'.$val->idToko); ?>"  onclick="return confirm('Yakin Akan Hapus Data Ini?')"> <button type="button "class="btn btn-secondary">Hapus</button></a>
                                </div>
                            </td>
                        </tr>
                    <?php $no++;
