                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" arial-label="Basic Example">
                                    <a href="<?php echo site_url('toko/get_by_id/' . $val->idKonsumen); ?>" class="btn btn-secondary">Edit</a>
                                    <a href="<?php echo site_url('produk/index/' . $val->idToko); ?>"><button type="button" class="btn btn-secondary">Kelola Toko</button></a>
                                    <a href="<?php echo site_url('toko/delete/' . $val->idKonsumen); ?>" class="btn btn-secondary">Hapus</a>
                                </div>
                            </td>
                        </tr>
                    <?php $no++;
